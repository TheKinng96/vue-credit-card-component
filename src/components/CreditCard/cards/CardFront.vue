    ...
    >
      <g id="Front">
        ...
        <text
          ...
          class="st2 st5 st6"
        >
          {{ isBusinessCard ? businessName : name }}
        </text>
        <text
          transform="matrix(1 0 0 1 54.1064 462.1723)"
          id="svgname2"
          class="st2 st5 st6"
        >
          {{ isBusinessCard ? name.toUpperCase() : '' }}
        </text>
        ...
        <g>
          <text
            ...
            class="st2 st5 st9"
          >
            {{ expiration || expirationPlaceholder }}
          </text>
          <text
...
export default class CardFront extends Vue {
  ...
  @Prop({ default: 'JOHN DOE' }) public name?: string;
  @Prop({ default: 'KABUSHIKI COREKARA' }) public businessName?: string;
  @Prop({ default: '01/23' }) public expiration?: string;
  @Prop({ default: 'grey' }) public color!: string;
  @Prop({ default: true }) public isTwoDigitsYear!: boolean;
  @Prop({ default: false }) public isBusinessCard!: boolean;
  @Prop() public trans!: object;

  get expirationPlaceholder() {
